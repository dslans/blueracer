...
def reward_function(params):
    ...
    #
    # This will be the main reward for the model. It will rely
    # on the car to learn the fastest way around the track.
    # The idea is that the car will learn a faster way around a track
    # than I can teach it.
    # ------------------------------------------------------
    progress_reward = 1.0
    TOTAL_NUM_STEPS = 200
    ...
    #
    # There is a short way around the track, highlighted by the racing line .
    # The car will get a small bonus if it is close to this line.
    # ------------------------------------------------------
    ...
    # Steering
    #
    # The car may try to steer to much to stay on track. This will slow the
    # car down, so I need to deincentivize excessive steering.
    # ------------------------------------------------------
    ...
    # Speed
    #
    # Need to incentivize the car to move fast
    # ------------------------------------------------------
    ...
    if all_wheels_on_track:
        reward = (4*progress_reward + 2*racingline_reward) * steering_factor
    else:
        reward = 1e-6
